  ...
  <header id="header">
    <div class="container">
      ...
      <h1 class="logo">
          ...
          <a href="http://deutscherentwicklerpreis.de/" title="<?php print t('Home'); ?>" rel="home" id="logo">
	...
	<div role="main" class="main">
	  ...
	  <?php if ( ($breadcrumb) OR (drupal_is_front_page()) ): ?>
	  <section class="page-top breadcrumb-wrap">
		  <div class="container">
		    <?php if (theme_get_setting('breadcrumbs') == '1'): ?>
				<div class="row">
					<div class="col-md-12">
						<?php if(drupal_is_front_page() && $breadcrumbs = '')
						{
	    ...
	    <div class="row">
	      ...
	      <?php if (theme_get_setting('ribbon') == '1'): ?>
				<div class="footer-ribbon">
					<a href="mailto:support@deutscherentwicklerpreis.de"><span><?php echo t("%string", array('%string' => theme_get_setting('ribbon_text')) );?></span></a>
				</div>
	      <?php endif; ?>
